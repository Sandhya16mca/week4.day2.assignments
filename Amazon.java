...
public class Amazon {
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		String priceOfFirstProduct = driver
				.findElement(By.xpath("(//div[@class='a-section'])[1]//span[@class='a-price-whole']")).getText();
		System.out.println("Price of first product is : " + priceOfFirstProduct);
		// Print the number of customer ratings for the first displayed product
		System.out.println(driver
				.findElement(By.xpath("//div//span[text()='RESULTS']//following::span[contains(text(),'stars')][1]"))
				.getText());
		...
		String cartvalue = driver
				.findElement(By.xpath("//span//b[contains(text(),'Cart subtotal')]//following::span//span")).getText();
